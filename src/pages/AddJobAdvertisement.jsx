...
export default function AddJobAdvertisement() {
  ...
  useEffect(() => {
    ...
    typeOfJobService
      .getTypesOfJob()
      .then((result) => setTypesOfJob(result.data.data));
          ...
          <Form onSubmit={formik.handleSubmit}>
            ...
            <Form.Field>
              ...
              <Dropdown
                ...
                selection
                onChange={(event, data) =>
                  handleChangeSemantic(data.value, "typeOfJobId")
                }
                onBlur={formik.onBlur}
                id="typeOfJobId"
              ...
              <Grid stackable>
                ...
                <Grid.Column width={8}>
                  ...
                  <Input
                    ...
                    onChange={(event, data) =>
                      handleChangeSemantic(data.value, "appDeadLine")
                    }
